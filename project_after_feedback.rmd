...
library(knitr)
knitr::opts_chunk$set(echo = TRUE, eval = T, tidy=TRUE,message=FALSE,warning=FALSE,strip.white=TRUE,prompt=FALSE,
                      cache=TRUE, size="scriptsize",
                      fig.width=6, fig.height=4.5, cex = 0.7, fig.align = "center")
```




```{r Loading Packages,eval=TRUE, echo = F}
# Load libraries
library(naniar)
library(mice)
library(glmnet)
