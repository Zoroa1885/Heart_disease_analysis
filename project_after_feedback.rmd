...
```{r Logistic Model, eval = F, fig.width= 4, fig.height=4}
...
To access the two models we compute the AIC and look at the confidence intervals from the model. We see that the AIC evaluates the model fitted on imputed data to be worse than 
