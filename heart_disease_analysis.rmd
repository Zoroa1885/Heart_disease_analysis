...
fit_for_simp_glucose_2 <- lm(glucose ~., data = x.train_dat2) # Q: Should the response be included? Open question :( We think no. Argue why later!
...
pred_glucose_test_2 <- predict(fit_for_simp_glucose_2, newdata = test_data_to_pred_gluc_2)



## Lets see what we predicted

plot(x.train_dat2$glucose)
plot(pred_glucose_train_2)

# Make histogram objects

hg_pred_gluc = hist(pred_glucose_train_2, plot = FALSE)
hg_old_gluc = hist(x.train_dat2$glucose, plot = FALSE)
...
# Could discuss whether or not this is the right approach, but we don't want to correlate the data even more, and therfore we don't base
# the prediction of cigs, BMI, etc... on the newly predicted glucose data and whatnot. Keep it simple with the old training data. 
...
fit_for_simp_cigs_2 <- lm(cigsPerDay ~., data = x.train_dat2) # Q: Should the response be included? Open question :( We think no. Argue why later!

# Checking if this is good. It is not. Adjusted R^2 is totally balls.
summary(fit_for_simp_cigs_2)

# Prediction 

# Which should be predicted?
train_data_to_pred_cigs_2 = ic(x.train_dat2)
train_data_to_pred_cigs_2 = train_data_to_pred_cigs_2[ici(train_data_to_pred_cigs_2$cigsPerDay),]

test_data_to_pred_cigs_2 = ic(x.test_dat2)
test_data_to_pred_cigs_2 = test_data_to_pred_cigs_2[ici(test_data_to_pred_cigs_2$cigsPerDay),]


# Predict them
pred_cigs_train_2 <- predict(fit_for_simp_cigs_2, newdata = train_data_to_pred_cigs_2) 
pred_cigs_test_2 <- predict(fit_for_simp_cigs_2, newdata = test_data_to_pred_cigs_2)



## Lets see what we predicted

plot(x.train_dat2$cigs)
plot(pred_cigs_train_2)

# Make histogram objects

hg_pred_cigs = hist(pred_cigs_train_2, plot = FALSE)
hg_old_cigs = hist(x.train_dat2$cigsPerDay, plot = FALSE)
...
x.train_dat2[ici(x.train_dat2$cigsPerDay),]$cigsPerDay <- pred_cigs_train_2
x.test_dat2[ici(x.test_dat2$cigsPerDay),]$cigsPerDay <- pred_cigs_test_2
...
fit_for_simp_BMI_2 <- lm(BMI ~., data = x.train_dat2) # Q: Should the response be included? Open question :( We think no. Argue why later!

# Checking if this is good. It is not. Adjusted R^2 is totally balls.
summary(fit_for_simp_BMI_2)

# Prediction 

# Which should be predicted?
train_data_to_pred_BMI_2 = ic(x.train_dat2)
train_data_to_pred_BMI_2 = train_data_to_pred_BMI_2[ici(train_data_to_pred_BMI_2$BMI),]

test_data_to_pred_BMI_2 = ic(x.test_dat2)
test_data_to_pred_BMI_2 = test_data_to_pred_BMI_2[ici(test_data_to_pred_BMI_2$BMI),]


# Predict them
pred_BMI_train_2 <- predict(fit_for_simp_BMI_2, newdata = train_data_to_pred_BMI_2) 
pred_BMI_test_2 <- predict(fit_for_simp_BMI_2, newdata = test_data_to_pred_BMI_2)



## Lets see what we predicted

plot(x.train_dat2$BMI)
plot(pred_BMI_train_2)

# Make histogram objects

hg_pred_BMI = hist(pred_BMI_train_2, plot = FALSE)
hg_old_BMI = hist(x.train_dat2$BMI, plot = FALSE)
...
x.train_dat2[ici(x.train_dat2$BMI),]$BMI <- pred_BMI_train_2
x.test_dat2[ici(x.test_dat2$BMI),]$BMI <- pred_BMI_test_2
...
fit_for_simp_totChol_2 <- lm(totChol ~., data = x.train_dat2) # Q: Should the response be included? Open question :( We think no. Argue why later!

# Checking if this is good. It is not. Adjusted R^2 is totally balls.
summary(fit_for_simp_totChol_2)

# Prediction 

# Which should be predicted?
train_data_to_pred_totChol_2 = ic(x.train_dat2)
train_data_to_pred_totChol_2 = train_data_to_pred_totChol_2[ici(train_data_to_pred_totChol_2$totChol),]

test_data_to_pred_totChol_2 = ic(x.test_dat2)
test_data_to_pred_totChol_2 = test_data_to_pred_totChol_2[ici(test_data_to_pred_totChol_2$totChol),]


# Predict them
pred_totChol_train_2 <- predict(fit_for_simp_totChol_2, newdata = train_data_to_pred_totChol_2) 
pred_totChol_test_2 <- predict(fit_for_simp_totChol_2, newdata = test_data_to_pred_totChol_2)



## Lets see what we predicted

plot(x.train_dat2$totChol)
plot(pred_totChol_train_2)

# Make histogram objects

hg_pred_totChol = hist(pred_totChol_train_2, plot = FALSE)
hg_old_totChol = hist(x.train_dat2$totChol, plot = FALSE)
...
x.train_dat2[ici(x.train_dat2$totChol),]$totChol <- pred_totChol_train_2
x.test_dat2[ici(x.test_dat2$totChol),]$totChol <- pred_totChol_test_2
...
fit_for_simp_heartRate_2 <- lm(heartRate ~., data = x.train_dat2) # Q: Should the response be included? Open question :( We think no. Argue why later!

# Checking if this is good. It is not. Adjusted R^2 is totally balls.
summary(fit_for_simp_heartRate_2)

# Prediction 

# Which should be predicted?
train_data_to_pred_heartRate_2 = ic(x.train_dat2)
train_data_to_pred_heartRate_2 = train_data_to_pred_heartRate_2[ici(train_data_to_pred_heartRate_2$heartRate),]


# Predict
pred_heartRate_train_2 <- predict(fit_for_simp_heartRate_2, newdata = train_data_to_pred_heartRate_2) 

## Add predictions into original data by changing those with incomplete glucose


x.train_dat2[ici(x.train_dat2$heartRate),]$heartRate <- pred_heartRate_train_2
...
fit_for_simp_BPMeds_2 <- glm(BPMeds ~., data = x.train_dat2, family = "binomial") # Q: Should the response be included? Open question :( We think no. Argue why later!

# Checking if this is good. It is not. Adjusted R^2 is totally balls.
summary(fit_for_simp_BPMeds_2)

# Prediction 

# Which should be predicted?
train_data_to_pred_BPMeds_2 = ic(x.train_dat2)
train_data_to_pred_BPMeds_2 = train_data_to_pred_BPMeds_2[ici(train_data_to_pred_BPMeds_2$BPMeds),]

test_data_to_pred_BPMeds_2 = ic(x.test_dat2)
test_data_to_pred_BPMeds_2 = test_data_to_pred_BPMeds_2[ici(test_data_to_pred_BPMeds_2$BPMeds),]


# Predict them (first numerically in (0,1), then classify to 0 or 1 depending on value)
pred_BPMeds_train_2_probs <- predict(fit_for_simp_BPMeds_2, newdata = train_data_to_pred_BPMeds_2, type = "response") 
pred_BPMeds_test_2_probs <- predict(fit_for_simp_BPMeds_2, newdata = test_data_to_pred_BPMeds_2, type = "response")

pred_BPMeds_train_2 <- ifelse(pred_BPMeds_train_2_probs >= 0.5, 1, 0)
pred_BPMeds_test_2 <- ifelse(pred_BPMeds_test_2_probs >= 0.5, 1, 0)


## Lets see what we predicted

plot(x.train_dat2$BPMeds)
plot(pred_BPMeds_train_2) # Seems like a reasonable (~ 1/41) was classified as 1, compared to the training data. 

# Make histogram objects

hg_pred_BPMeds = hist(pred_BPMeds_train_2, plot = FALSE)
hg_old_BPMeds = hist(x.train_dat2$BPMeds, plot = FALSE)
...
x.train_dat2[ici(x.train_dat2$BPMeds),]$BPMeds <- pred_BPMeds_train_2
x.test_dat2[ici(x.test_dat2$BPMeds),]$BPMeds <- pred_BPMeds_test_2
...
fit_for_simp_edu_2 <- gknn(education ~., data = x.train_dat2) # Q: Should the response be included? Open question :( We think no. Argue why later!

# Checking if this is good. Idk? Not understandable when using KNN.
summary(fit_for_simp_edu_2)

# Prediction 

# Which should be predicted?
train_data_to_pred_edu_2 = ic(x.train_dat2)
train_data_to_pred_edu_2 = train_data_to_pred_edu_2[ici(train_data_to_pred_edu_2$education),]

test_data_to_pred_edu_2 = ic(x.test_dat2)
test_data_to_pred_edu_2 = test_data_to_pred_edu_2[ici(test_data_to_pred_edu_2$education),]


# Predict them (first numerically in (0,1), then classify to 0 or 1 depending on value)
pred_edu_train_2 <- predict(fit_for_simp_edu_2, newdata = train_data_to_pred_edu_2, type = "class") 
pred_edu_test_2 <- predict(fit_for_simp_edu_2, newdata = test_data_to_pred_edu_2, type = "class")


## Lets see what we predicted

plot(x.train_dat2$education)
plot(pred_edu_train_2) # Seems like a reasonable (~ 1/41) was classified as 1, compared to the training data. 

## Add predictions into original data by changing those with incomplete glucose


x.train_dat2[ici(x.train_dat2$education),]$education <- pred_edu_train_2
x.test_dat2[ici(x.test_dat2$education),]$education <- pred_edu_test_2
