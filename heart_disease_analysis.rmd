...
points(seq(1,length(x.train_dat2[,1]),length.out = length(pred_glucose_train_2)),pred_glucose_train_2, col = "orange")
abline(h = mean(x.train_dat2$glucose), col = "red")
...
fit_for_simp_heartRate_2 <- lm(heartRate ~., data = x.train_dat2) 
...
fit_for_simp_BPMeds_2 <- glm(BPMeds ~., data = x.train_dat2, family = "binomial")
