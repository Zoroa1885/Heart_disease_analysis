...
```{r Missing data train-pred-plots, echo = F}
...
```{r Manually Imputed Lasso model, echo = F}
...
```{r Mice Imputed Lasso model, echo = F}
set.seed(8701)
# Cross-validation
...
```{r Bootstrap Lasso with imputed data, echo = F}
set.seed(8701)
B = 500
...
The Lasso on imputed data chose 'r names_lasso_imp_70', which matches the complete case quite well. 
