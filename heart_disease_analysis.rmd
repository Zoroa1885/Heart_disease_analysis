...
We plot the number of negative and positive cases of in the dataset.
...
ggplot(data = response, aes(TenYearCHD), main = "Frequency of postive vs. negative cases")+geom_bar()
```
